...
def get_albums(evt):
    result = m.get_artist_by_id( \
        evt.target.get_selected_items()[0]['id'], \
...
def get_tracks(evt):
    albumslist = m.get_release_group_by_id(\
        evt.target.get_selected_items()[0]['id'], \
        includes="releases")
    resultList = []
    ...
    print("=========================")
    print("=========================")
    tracks = m.get_release_by_id(\
        albumslist['release-group']['release-list'][0]['id'], \
